...
NSString * const YALCenterButtonExpandAnimation = @"CENTER_BUTOON_EXPAND_ANIMATION";
NSString * const YALCenterButtonCollapseAnimation = @"CENTER_BUTOON_COLLAPSE_ANIMATION";
